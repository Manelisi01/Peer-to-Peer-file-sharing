...
/**
 * The Leecher class is responsible for downloading a file from multiple seeders
 * using a peer-to-peer (P2P) approach. It communicates with a tracker to get a list
 * of seeders, downloads the file in chunks, and assembles the file. It also provides
 * a graphical user interface (GUI) to display the download progress.
 */
public class Leecher {
    ...
    /**
     * Constructs a Leecher object and initializes the GUI.
     */
    public Leecher() {
        // Initialize the GUI
        initializeGUI();
    ...
    /**
     * Initializes the GUI components, including the frame, progress bar, and status label.
     */
    ...
    /**
     * Updates the progress bar and status label in the GUI.
     *
    ...
    /**
     * The main method to start the Leecher application.
     *
     * @param args Command-line arguments: <TARGET_FILE> <TRACKER_IP> <LEECHER_IP> <LEECHER_IP_PORT>.
     ...
     * @throws Exception If an error occurs during communication with the tracker.
     */
